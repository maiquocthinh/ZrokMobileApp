...
class AppTheme {
    ...
    return ThemeData(
      ...
      switchTheme: SwitchThemeData(
        thumbColor: WidgetStateProperty.resolveWith(
          (states) => states.contains(WidgetState.selected) ? teal : outline,
        ),
  ...
  static TextStyle get mono =>
      GoogleFonts.jetBrainsMono(fontSize: 13, color: onSurface);
  static TextStyle get monoSmall =>
      GoogleFonts.jetBrainsMono(fontSize: 11, color: onSurfaceVariant);
  static TextStyle get monoTeal =>
      GoogleFonts.jetBrainsMono(fontSize: 13, color: teal);
}
