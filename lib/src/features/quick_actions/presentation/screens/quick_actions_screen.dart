...
class QuickActionsScreen extends StatelessWidget {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                '$envName${version != null ? ' (v$version)' : ''}',
              ...
              Row(
                children: [
                  ...
                  IconButton(
                    ...
                    onPressed: () =>
                        _showAddEditDialog(context, manager, action: action),
                  ),
                  IconButton(
  ...
  void _showAddEditDialog(
    ...
    String selectedEnvId =
        action?.envId ??
        (manager.enabledEnvs.isNotEmpty ? manager.enabledEnvs.first.id : '');
            ...
            children: [
              ...
              TextField(
                ...
                decoration: const InputDecoration(
                  hintText: 'Command (e.g. share public)',
                ),
              ),
              const SizedBox(height: 12),
            ...
            ElevatedButton(
              onPressed: () {
                if (nameCtrl.text.isEmpty ||
                    cmdCtrl.text.isEmpty ||
                    selectedEnvId.isEmpty) {
                  return;
                }
                if (isEdit) {
                  manager.updateQuickAction(
                    action.id,
                    nameCtrl.text,
                    cmdCtrl.text,
                    selectedEnvId,
