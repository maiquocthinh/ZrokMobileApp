...
class _HistoryScreenState extends State<HistoryScreen> {
          ...
          child: CustomScrollView(
            slivers: [
              ...
              if (results.isEmpty)
                ...
                ...grouped.entries.map(
                  (group) => _buildGroup(manager, group.key, group.value),
                ),
            ],
          ),
        );
  ...
  Widget _buildHistoryCard(AppController manager, HistoryEntry entry) {
    return Dismissible(
      key: Key(entry.id),
        ...
        child: Padding(
          ...
          child: Row(
            children: [
              ...
              _iconBtn(
                Icons.star_outline,
                () => _saveAsQuickAction(manager, entry),
              ),
              _iconBtn(
  ...
  void _saveAsQuickAction(AppController manager, HistoryEntry entry) {
  ...
  void _confirmClear(AppController manager) {
    showDialog(
      context: context,
      builder: (ctx) => AlertDialog(
